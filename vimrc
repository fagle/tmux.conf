...
func SetTitle()
    ...
    if &filetype == 'sh'
        ...
        call append(line(".")+1, "\# Author: fagle")

        call append(line(".")+2, "\# mail: ifagle@163.com")
    ...
    if &filetype == 'h'
		call append(line(".") + 6, "#ifndef __" . expand("%") . "__")
		call append(line(".") + 7, "#define __" . expand("%") ."__")
        call append(line(".") + 8, "")
        call append(line(".") + 9, "")
...
" auto open the NERDTree while open the vim
